...
-- NOTE: Reordenar buffers
vim.keymap.set('n', '<A-<>', '<Cmd>BufferMovePrevious<CR>', opts)
vim.keymap.set('n', '<A->>', '<Cmd>BufferMoveNext<CR>', opts)

-- NOTE: Ir para buffer em posição específica
...
-- NOTE: Fixar / desafixar buffer
vim.keymap.set('n', '<A-p>', '<Cmd>BufferPin<CR>', opts)

-- NOTE: Ir para buffer fixado ou não fixado (somente comandos disponíveis)
-- :BufferGotoPinned
-- :BufferGotoUnpinned
...
-- NOTE: Wipeout buffer (somente comando disponível)
-- :BufferWipeout

-- NOTE: Comandos extras de fechamento
...
-- NOTE: Modo mágico de seleção de buffer
vim.keymap.set('n', '<C-p>', '<Cmd>BufferPick<CR>', opts)
vim.keymap.set('n', '<C-s-p>', '<Cmd>BufferPickDelete<CR>', opts)

-- NOTE: Ordenar buffers automaticamente
